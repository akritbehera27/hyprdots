...
" Startup Settings
  ...
  set cursorline
  highlight CursorLine ctermbg=Yellow cterm=bold guibg=#20202e
...
inoremap <silent> <Bar>   <Bar><Esc>:call <SID>align()<CR>a
  ...
  "formatoptions-=r: This removes the 'r' flag from 'formatoptions', which is related to automatically inserting the comment eader when you press Enter in insert mode after a line that starts with a comment.
